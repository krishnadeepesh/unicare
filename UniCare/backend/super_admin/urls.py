...
urlpatterns = [
    ...
    path('patients/all/', workflows.get_all_patients, name='get_all_patients'),
    path('patients/update/', workflows.update_patient, name='update_patient'),
    path('patients/allergies/', workflows.update_patient_allergies, name='update_patient_allergies'),
